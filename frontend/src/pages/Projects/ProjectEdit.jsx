    ...
    const fetchProjectData = async () => {
        try {
            ...
            if (response.data.success) {
                const { project, customers, members, billingTypes, status, tags, selectedMembers } = response.data.data;

                setSyncData({ customers, members, billingTypes, status, tags });
                ...
                setFormData({
                    ...
                    calculate_progress_through_tasks: project.calculate_progress_through_tasks || false,
                    progress: parseInt(project.progress) || 0,
                    billing_type: project.billing_type?.toString() || '',
                    ...
                    send_email: project.send_email || false
                });
            }
        } catch (error) {
